...
Then copy the `.env.example` file and rename it to `.env`. In this file you have to add your database connection information, your port to run server, stateTransitionContract address, RPC Provider, ziden_server_uri, authen_server_uri ...
